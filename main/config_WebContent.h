...
#  define configure_6 "<p><form action='rl' method='get'><button>Configure RTL_433</button></form></p>"
#else
#  define configure_6
#endif
#define configure_7
...
const char config_rtl_433_body[] = body_header
    "<fieldset class=\"set1\">"
    "<legend><span><b>Configure RTL_433</b></span></legend>"
    "<form method='get' action='rl'>"
